...
var midade = mostraIdade(usuario);
console.log(midade); // 3.3
...
var a = mostraUsuario(nome, idade);
var b = mostraUsuario(nome);
console.log(a, b); // 3.4
